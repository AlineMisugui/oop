...
Circle.name; 
Circle.length; // returns the number of parameters of function
Circle.constructor; // returns Function()
Circle.call({}, 1); // to call the Circle function 
Circle.apply({}, [1]);

// Value types are copied by their value, reference types are copied by their reference of memory. 
...
for (let key in circle) console.log(key, circle[key]); // key: property's name, circle[key]: value of property

Object.keys(circle); // returns the name of properties
